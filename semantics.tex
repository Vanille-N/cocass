...
\(alloc^i: \mathcal{M}\to \ZZ_{64}\sqcup\{\bot\}\) is such that if \(k = alloc^i(\mu) \ne \bot\) then \(\forall 0\leq j < i, k+j\not\in\dom\mu\). In what follows we assume that \(alloc^i(\mu)\) is never \(\bot\), i.e. all rules that use \(k = alloc^i(\mu)\) have the implicit precondition \(k\ne\bot\).
...
\[\dfrac{\begin{array}{c}
    ...
    \rho,\mu_e,\chi_e,v_e \gives^e \t{OP1}(\t{M\_ADDR}, a) \tto \rho,\mu_a,\nil,v_a
\end{array}}{\rho,\mu,\chi,v \gives^e \t{SET}(a, e) \tto \rho,\mu_a^{64}[v_a\mapsto v_e],\nil,v_e}\rule{Ptr}{^\gets}\]
\[\dfrac{\begin{array}{c}
    \rho,\mu,\chi,v \gives^e e \tto \rho,\mu_e,\chi_e,v_e \\
    \rho,\mu_e,\chi_e,v_e \gives^e \t{OP1}(\t{M\_ADDR}, a) \tto \rho,\mu_a,\chi_a,v_a \qquad \chi_a\ne\nil
\end{array}}{\rho,\mu,\chi,v \gives^e \t{SET}(a, e) \tto \rho,\mu_a,\chi_a,v_a}\rule{Ptr}{^{\gets\chi}}\]

\subsection{Increments}
\[\dfrac{\begin{array}{c}
    \rho,\mu,\chi,v \gives^e \t{OP1}(\t{M\_ADDR}, a)\tto \rho,\mu_a,\nil,v_a \\
    k = \mu_a^{64}(v_a)
\end{array}}{\rho,\mu,\chi,v \gives^e \t{OP1}(\t{M\_POST\_INC}, a) \tto \rho,\mu_a^{64}[v_a\mapsto k+1],\nil,k} \rule{Post}{^\uparrow}\]
\[\dfrac{\begin{array}{c}
    \rho,\mu,\chi,v \gives^e \t{OP1}(\t{M\_ADDR}, a)\tto \rho,\mu_a,\nil,v_a \\
    k = \mu_a^{64}(v_a)
\end{array}}{\rho,\mu,\chi,v \gives^e \t{OP1}(\t{M\_POST\_DEC}, a) \tto \rho,\mu_a^{64}[v_a\mapsto k-1],\nil,k} \rule{Post}{^\downarrow}\]
\[\dfrac{\begin{array}{c}
    \rho,\mu,\chi,v \gives^e \t{OP1}(\t{M\_ADDR}, a)\tto \rho,\mu_a,\nil,v_a \\
    k = \mu_a^{64}(v_a)
\end{array}}{\rho,\mu,\chi,v \gives^e \t{OP1}(\t{M\_PRE\_INC}, a) \tto \rho,\mu_a^{64}[v_a\mapsto k+1],\nil,k+1} \rule{Pre}{^\uparrow}\]
\[\dfrac{\begin{array}{c}
    \rho,\mu,\chi,v \gives^e \t{OP1}(\t{M\_ADDR}, a)\tto \rho,\mu_a,\nil,v_a \\
    k = \mu_a^{64}(v_a)
\end{array}}{\rho,\mu,\chi,v \gives^e \t{OP1}(\t{M\_PRE\_DEC}, a) \tto \rho,\mu_a^{64}[v_a\mapsto k-1],\nil,k-1} \rule{Pre}{^\downarrow}\]
...
\[\dfrac{\begin{array}{c}
    \rho,\mu,\chi,v \gives^e e \tto \rho,\mu_e,\chi_e,v_e \\
    \rho,\mu_e,\chi_e,v_e \gives^e \t{OP1}(\t{M\_ADDR}, a) \tto \rho,\mu_a,\chi_a,v_a \\
    v_a\in\dom\mu_a \qquad \mu_a^{64}(v_a) = u \\
    \rho,\mu_a,\chi_a,v_a \gives^e \t{OP2}(op, \t{CST}\ v_a, \t{CST}\ v_e) \tto \rho,\mu',\nil,w
\end{array}}{\rho,\mu,\chi,v \gives^e \t{OPSET}(op, a, e) \tto \rho,\mu'[v_a\mapsto w],\nil,w} \rule{Opset}{}\]
\[\dfrac{\begin{array}{c}
    \rho,\mu,\chi,v \gives^e e\tto \rho,\mu_e,\chi_e,v_e \\
    \rho,\mu_e,\chi_e,v_e \gives^e \t{OP1}(\t{M\_ADDR}, a) \tto \rho,\mu_a,\chi_a,v_a \\
    \chi_a\ne\nil \\
\end{array}}{\rho,\mu,\chi,v \gives^e \t{OPSET}(op, a, e) \tto \rho,\mu_a,\chi_a,v_a} \rule{Opset}{^\chi}\]
