...
\[\dfrac{
}{\rho,\mu,\chi,v \gives^{e?} \t{None} \tto \rho,\mu,\chi,v} \rule{None}{}\]
\[\dfrac{
    \rho,\mu,\chi,v \gives^e f \tto \rho_f,\mu_f,\chi_f,v_f
}{\rho,\mu,\chi,v \gives^{e?} \t{Some}\ f \tto \rho_f,\mu_f,\chi_f,v_f} \rule{Some}{}\]
...
\[\dfrac{\begin{array}{c}
    \rho,\mu,\chi,v \gives e \tto \rho,\mu_e,\chi_e,v_e \\
    \rho,\mu_e,\chi_e,v_e \gives \t{CBLOCK}(L(v_e)) \tto \rho,\mu_l,\chi_l,v_l
